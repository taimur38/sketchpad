...
const Plane = lazy(() => import('../Plane2'));

export default function Main() {
  const [dims, setDims] = useState({ height: window.innerHeight, width: window.innerWidth });

  useEffect(() => {
    const onResize = () => setDims({ height: window.innerHeight, width: window.innerWidth });
    ...
    <div className="main">
      <div className="visual">
        <Suspense fallback={null}>
          <Plane height={dims.height} width={dims.width} />
        </Suspense>
      </div>
      ...
      <div className="about">
        <div className="liner">
          <p>
            ...
            entrepreneurial opportunities. <br /><br />
            I am currently obtaining my{' '}
            <Out url="https://www.hks.harvard.edu/educational-programs/masters-programs/master-public-administration-international-development">
              Masters in Public Administration in International Development from
            ...
            , in the fields of Industrial Policy, Pension reform, Fiscal policy,
            data management and reform monitoring. <br /><br />
            Prior to coming the program, I started the Labs unit at the Centre
            ...
            sustainable model which has actualized the insights from research and
            scales up the impact from these findings. <br /><br />
            Before coming to CERP, I was a Software Architect at{' '}
            <Out url="https://www.ibm.com/watson/">Watson</Out>. Before that, I
            was VP of Engineering at{' '}
