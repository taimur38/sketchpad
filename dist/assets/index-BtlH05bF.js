import{r as _,j as h}from"./index-Bo-R9qKG.js";import{V as a,P as x,S as g,W as M,e as k,f as R,a as z}from"./three.module-ICs-E19M.js";const b=`/* these are already supplied ...
...
}`;function j(){const r=_.useRef(null);return _.useEffect(()=>{let i=0;const t=new a,s=new a,c=new a,o=new x(70,window.innerWidth/window.innerHeight,1,1e3);o.position.z=400;const m=new g,e=new M;e.setPixelRatio(window.devicePixelRatio),e.setSize(window.innerWidth,window.innerHeight);const p=new k(800,600,300,400),n=new R({vertexShader:b,fragmentShader:P,uniforms:{ticks:{value:i},mouse:{value:t},left_hand:{value:s},head:{value:c},kinect:{value:0}}}),w=new z(p,n);m.add(w);const d=()=>{e.setSize(window.innerWidth,window.innerHeight),o.aspect=window.innerWidth/window.innerHeight,o.updateProjectionMatrix()},l=v=>{t.x=v.clientX/window.innerWidth,t.y=1-v.clientY/window.innerHeight};window.addEventListener("resize",d),window.addEventListener("mousemove",l),r.current.appendChild(e.domElement);let u;const f=()=>{u=requestAnimationFrame(f),i+=1,n.uniforms.ticks.value=i,n.uniforms.mouse.value=t,n.uniforms.left_hand.value=s,n.uniforms.head.value=c,e.render(m,o)};return f(),()=>{cancelAnimationFrame(u),window.removeEventListener("resize",d),window.removeEventListener("mousemove",l),e.dispose()}},[]),h.jsx("div",{ref:r})}export{j as default};
